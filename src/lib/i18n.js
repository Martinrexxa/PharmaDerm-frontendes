...
export const translations = {
  es: {
    ...
    routine: {
      ...
      emptyText:      'Completa el quiz o un diagnóstico para generar tu rutina personalizada.',
      ...
      goDiagnostics:  'Ir a diagnóstico',
    ...
    profile: {
      ...
      viewUpdateDiagnostic: 'Ver o actualizar diagnóstico',
    ...
    footer: {
      ...
      phone: 'Teléfono',
      consent: 'Al enviar este formulario, acepto recibir recomendaciones de skincare, novedades de productos, recordatorios de citas y mensajes promocionales de PharmaDerm. Entiendo que puedo cancelar mi suscripción en cualquier momento.',
      submit: 'ENVIAR',
